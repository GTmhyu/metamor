...
Command: npx gltfjsx@6.5.3 room2.glb 
...
export function Room2(props) {
  ...
  const { nodes, materials, animations } = useGLTF('/models/room2.glb')
  const { actions } = useAnimations(animations, group)
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Sketchfab_Scene">
        <group name="Sketchfab_model" rotation={[-Math.PI / 2, 0, 0]} scale={48.673}>
          <group name="2ef80b1dfb734b42bd96b1da8449f9a9fbx" rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
            <group name="Object_2">
              <group name="RootNode">
                <group name="aiAreaLight4" position={[0.733, 3.853, 5.454]} rotation={[0, -0.021, 0]} scale={[4.251, 3.05, 2.238]} />
                <group name="camera1" position={[1.546, 2.475, 5.015]} rotation={[-Math.PI, 1.257, 3.079]}>
                  <group name="Object_5" />
                </group>
                <group name="aiAreaLight2" position={[0.377, 7.868, 0.111]} rotation={[-1.139, 0, 0]} scale={[3.701, 1.69, 7.271]} />
                <group name="aiAreaLight3" position={[-0.741, 1.965, -3.97]} rotation={[Math.PI / 2, 0, 0]} scale={[1.717, 0.04, 7.271]} />
                <group name="room">
                  <group name="pCube10">
                    <mesh name="pCube10_tabel_wood_0" geometry={nodes.pCube10_tabel_wood_0.geometry} material={materials.tabel_wood} />
                  </group>
                  <group name="polySurface93" position={[-0.869, 0.008, -0.268]} rotation={[0, -0.664, 0]} scale={1.101}>
                  ...
                  <group name="polySurface101" position={[-3.938, 1.114, 4.933]} rotation={[0, -0.664, 0]} scale={[1.101, 0.197, 1.101]}>
                  ...
                  <group name="polySurface88" position={[-0.869, 0.008, -0.268]} rotation={[0, -0.664, 0]} scale={1.101}>
                  ...
                  <group name="polySurface87" position={[-0.869, 0.008, -0.268]} rotation={[0, -0.664, 0]} scale={1.101}>
                  ...
                  <group name="polySurface94" position={[-0.869, 0.008, -0.268]} rotation={[0, -0.664, 0]} scale={1.101}>
                  ...
                  <group name="polySurface22" position={[3.218, -44.572, -1.282]} scale={[0.269, 27.839, 0.665]}>
